    ...
    <div className="flex flex-col min-h-screen">
      ...
      >
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl text-white font-bold">{t('contact_us.title')}</h1>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="mx-20 grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Contact Form */}
          <div>
            <h2 className="text-2xl font-bold text-gray-700 mb-8">{t('contact_us.contact_form.title')}</h2>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="bg-blue-600 text-white px-8 py-3 rounded hover:bg-blue-700 transition-colors inline-flex items-center"
              >
          ...
          {/* Contact Details */}
          <div className="">
            <h2 className="text-2xl font-bold text-gray-700 mb-8">{t('contact_us.contact_info.title')}</h2>
