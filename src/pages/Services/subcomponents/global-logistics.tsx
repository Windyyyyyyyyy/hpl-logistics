const GlobalLogistics = () => {
  return (
    <div className="bg-gray-50 p-6 text-gray-800">
      <h1 className="mb-4 text-2xl font-bold">GLOBAL LOGISTICS</h1>
      <p className="mb-4">
        ...
        solutions, sea freight is often the preferred choice. Using our contacts with all the major
        shipping lines, we offer services with different transit times, enabling customers to make
        accurate forecasts and keep costs within budget.
      </p>
      ...
      <ul className="list-disc space-y-2 pl-6">
        ...
        <li>All equipment available: 20GP and 40GP; High Cubes; Reefers; Open Tops; Flat racks.</li>
        <li>
          Regular departures to/from all international ports worldwide working with various shipping
          lines.
        </li>
      </ul>
    </div>
