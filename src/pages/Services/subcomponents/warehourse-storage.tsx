const WarehouseSolutions = () => {
  return (
    <div className="bg-gray-50 p-6 text-gray-800">
      <h1 className="mb-6 text-2xl font-bold">WAREHOUSE/STORAGE SOLUTIONS</h1>

      <p className="mb-6">
        Our newly refurbished state of the art 60,000 sq.ft. secure warehouse and distribution
        facility in Shenzhen,China has over 10,000 pallet spaces of racking, secure storage rooms, 3
        mezzanine floors for pick and pack operations, 4 loading bays each able to accommodate
      ...
      <p>
        ...
        in the right place, packaged and delivered on time is crucial to deliver the instore/online
        experience customers now expect.
      </p>
    </div>
  );
};
